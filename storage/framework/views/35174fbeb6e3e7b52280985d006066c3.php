...
<html lang="uz">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="<?php echo e(asset('landing-page/favicon.ico')); ?>" />
        <link href="<?php echo e(asset('landing-page/styles.css')); ?>" rel="stylesheet" />
                        ...
                        <div class="mb-5 text-center text-lg-start">
                            ...
                            <div class="d-flex flex-column flex-lg-row align-items-center">
                                <a class="me-lg-3 mb-4 mb-lg-0" href="#">
                                    <img class="app-badge" src="<?php echo e(asset('landing-page/img/google-play-badge.svg')); ?>" />
                                </a>
                                <a href="#">
                                    <img class="app-badge" src="<?php echo e(asset('landing-page/img/app-store-badge.svg')); ?>" />
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        <video muted autoplay loop style="max-width: 100%; height: 100%">
                                            <source src="<?php echo e(asset('landing-page/img/demo-screen.mp4')); ?>" type="video/mp4" />
                                        </video>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="bg-gradient-primary-to-secondary" id="download">
            <div class="container px-5">
                <h2 class="text-center text-white mb-4">
                    Qadam ilovasini hoziroq yuklab oling
                </h2>
                <div class="d-flex justify-content-center">
                    <a class="me-3" href="#"><img class="app-badge" src="<?php echo e(asset('landing-page/img/google-play-badge.svg')); ?>"></a>
                    <a href="#"><img class="app-badge" src="<?php echo e(asset('landing-page/img/app-store-badge.svg')); ?>"></a>
                </div>
            </div>
        </section>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/get-fast/resources/views/welcome.blade.php ENDPATH**/ ?>