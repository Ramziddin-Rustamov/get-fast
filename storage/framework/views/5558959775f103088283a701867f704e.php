...
<div class="card mb-4 shadow-sm">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            <h5 class="card-title">✉ Mijozni telefon raqamiga SMS yuborish . Mijoz tili : <span class="fw-bold badge bg-success" ><?php echo e($client->authLanguage->language); ?></span></h5>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/get-fast/resources/views/admin-views/clients/show.blade.php ENDPATH**/ ?>